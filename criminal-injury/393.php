<?php
    $bodyclass = "";
    $documenttitle = "Apply for compensation &middot; Incident details";
        ...
        <div class="control-group">
          ...
          <div class="form-group inline">
            ...
            <label class="block-label" for="r2-2">
              <input id="r2-2" name="radio-indent-group-1" value="2" type="radio">
              No
            </label>
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="form-group inline">
            ...
            <label class="block-label" for="r2-2-2">
              <input id="r2-2-2" name="radio-indent-group-1-1" value="2" type="radio">
              No
            </label>
          </div>
        </div>
