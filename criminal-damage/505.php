<?php
    $bodyclass = "";
    $documenttitle = "Apply for compensation &middot; Company details";
...
<!--     <p>The applicant is the person applying for compensation on behalf of a company.</p>
 -->
    ...
    <form action="post" class="form">
        ...
        <fieldset>
            <!-- <legend class="instruction">Registered office address</legend> -->
                <div class="control-group">
                    <label class="form-label" for="txt_firstname">
                        <img src="/images/required.gif" class="required" alt="Required information">
                        Company name
