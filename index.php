            ...
            <div class="control-group">
                ...
                <div class="form-group inline">
                    <label class="block-label" for="id1">
                        <input id="id1" name="group" value="1" type="radio"> Big radio 1
                    </label>
                    <label class="block-label" for="id2">
                        <input id="id2" name="group" value="2" type="radio"> Big radio 2
                    </label>
                </div>
            </div>
            <div class="control-group">
            ...
            <fieldset>
                ...
                <div class="form-group form-group-compound">
                    ...
                    <label class="block-label" for="radio-indent-55">
                        <input id="radio-indent-55" name="radio-indent-group" value="Combo" type="checkbox"> I agree
                    </label>
                </div>
            </fieldset>
        </form>
                ...
                <fieldset class="inline">
                    ...
                    <div class="form-group form-group-compound">
                        <label class="block-label" for="r1x">
                            <input id="r1x" name="radio-indent-group" value="1" type="radio"> Annual
                        </label>
                        <label class="block-label" data-target="permit-form" for="r2x">
                            <input id="r2x" name="radio-indent-group" value="2" type="radio"> 14 days
                        </label>
                        <label class="block-label" data-target="permit-form" for="r3x">
                            <input id="r3x" name="radio-indent-group" value="3" type="radio"> 3 days
                        </label>
                    </div>
                </fieldset>
            </div>
                ...
                <fieldset class="inline">
                    ...
                    <div class="form-group form-group-compound">
                        <label class="block-label" for="xr1">
                            <input id="xr1" name="radio-indent-group" value="1" type="radio"> Annual
                        </label>
                        <label class="block-label" data-target="permit-form" for="xr2">
                            <input id="xr2" name="radio-indent-group" value="2" type="radio"> 14 days
                        </label>
                        <label class="block-label" data-target="permit-form" for="xr3">
                            <input id="xr3" name="radio-indent-group" value="3" type="radio"> 3 days
                        </label>
                    </div>
                </fieldset>
            </div>
