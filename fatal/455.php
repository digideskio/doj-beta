<?php
    $bodyclass = "";
    $documenttitle = "Claimant's employment details | Apply for compensation | nidirect";
...
<div class="content container">
    ...
    <h2 class="no-top-margin">Employment details</h2>
        ...
        <div class="control-group" id="2">
            <label class="form-label" for="n1">
                Enter the name of your employer (if any)
            </label>
            <input name="n1" type="text" id="n1">
        </div>

        <h2>Address of your employer</h2>
            <fieldset>
                    <div class="control-group">
        ...
        <div class="control-group">
            <label class="form-label"> Payroll number (if any) </label>
