...
<div class="content container">
    ...
    <form action="post" class="form">
        ...
        <div class="control-group" id="7">
            <label for="comp-other" class="form-label text">If 'Yes' was selected for either of the previous 2 questions, enter details here</label>
            <textarea name="comp-other" id="comp-other" cols="30" rows="5"></textarea>
        </div>
        ...
        <div class="well text">
                ...
                <ul class="form-label text">
                  ...
                  <li>Funeral account - if applicable, showing the sexpenses incurred and details of payments made</li>
                  <li>Marriage Certificate - if applicable</li>
                  <li>Documentary evidence - to prove your claim that you lived as husband and wife or as same sex partners in the same household immediately for at least 2 years before the date of death or had a 'close and loving relationship' with the deceased</li>
